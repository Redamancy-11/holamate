...
const memoryReviews = [
  ...
  { id: 3, user_type: 'buyer', user_name: 'Minh Đức', rating: 5, comment: 'Thông tin di chuyển xe bus 107 và 74 trên app cập nhật rất chuẩn. Đi lại từ nội thành lên Hòa Lạc cuối tuần không còn là cực hình nữa.', page_path: '/' },
  ...
  { id: 5, user_type: 'seller', user_name: 'Chủ Tiệm Bay Coffee', rating: 5, comment: 'Hệ thống chiết khấu hoa hồng của HolaMate rất hợp lý và công bằng. Đơn hàng nổ liên tục vào giờ cao điểm học nhóm.', page_path: '/' },
  { id: 6, user_type: 'seller', user_name: 'Chủ Quán Lẩu 1988', rating: 5, comment: 'Tính năng định vị GPS giúp tài xế tìm đường đến quán tôi cực nhanh, đồ ăn giao cho các bạn sinh viên vẫn giữ được độ nóng hổi.', page_path: '/' }
];
