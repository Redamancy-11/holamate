...
const reviews = [
  ...
  { name: 'Minh Đức', role: 'K18 Business Administration', country: '🍊', avatar: 'MĐ', color: '#A78BFA', rating: 5, text: 'Thông tin di chuyển xe bus 107 và 74 trên app cập nhật rất chuẩn. Đi lại từ nội thành lên Hòa Lạc cuối tuần không còn là cực hình nữa. AI trả lời gợi ý quán ăn, xe bus quanh đây rất mượt!' },
